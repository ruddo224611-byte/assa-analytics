...
- [ ] **Week 2:** 전국 22,000+ 행정동 × 100업종 풀스케일 빌드. NTS↔SBIZ 매핑 1% 운영자 검증 (Week 끝). reference 매핑(region-codes / reb-zone-mapping) 전국 확장
  ...
  - [x] **Day 3:** 광역시 7개 51 시군구 (PR #15)
  - [x] **Day 4:** 도 5개 (경기·강원·충북·충남·제주) 97 시군구 ([docs/phase1/week2-day4.md](phase1/week2-day4.md)). SBIZ 429 rate limit 발견 → 자동 재시도 로직 추가. 누락 9 시군구 재빌드 성공
  - [ ] **Day 5:** 도 4개 (전북·전남·경북·경남) ~82 시군구 + Week 2 종합. 누적 ~255 시군구 / ~200MB
